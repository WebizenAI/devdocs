The agentAPI is basically an alternative to foaf.

The AgentAPI (ontology) will interface with the [[HumanCentricOntology]] that will be defined seperately as to seek to ensure that the references made within that ontology is not as easily semantically misused via the concept of 'thing', etc.
