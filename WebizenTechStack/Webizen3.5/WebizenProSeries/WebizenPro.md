...
The [[VerifiableClaims&Credentials]] / [[OpenBadges]] components seek to employ work that has been produced via W3C to support cryptographically secured documents; that are in-turn able to be used for many different applications. 
...
4.  WebHost Components (advancing the [[HostServiceRequirements]] )
