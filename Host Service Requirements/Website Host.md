The "Web Host" [[../Implementation V1/vps/Server Functionality Summary (VPS|Server Functionality Summary (VPS|[VPS)]]]].md) is intended to provide information about the VPS (virtual Private Server) side functionality required to support local 'webizen' servers.
